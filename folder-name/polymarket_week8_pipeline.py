...
from src.equity_signal import EquitySignalConfig, REGIME_PENALTY_SCALES, get_regime
...
def main() -> None:
    ...
    experiment_config = ExperimentConfig(
        ...
        enable_equity_signal=False,
        equity_signal_lambda=0.0,
        equity_signal_lambdas=(0.0, 0.05, 0.1),
    ...
    # Regime-adaptive risk scaling from VIX context.
    ...
    for key, value in data_artifacts.items():
        print(f"- {key}: {value}")
    equity_regime_path = project_root / "data" / "processed" / "week8_pipeline_equity_regime.json"
